...
1. **Retrieves** the 15 most similar historical rulemaking challenges from a curated reference set of 602 challenged rulemakings (FY 2008–2026), using hybrid dense-embedding + categorical similarity.
...
- **602 rulemaking challenges** — federal rules that went to a published circuit-court opinion, enriched with Federal Register metadata (agency, CFR references, publication date, abstract, topics, significance flag).
- **26,835 matched appellate cases** in the broader corpus (the rulemaking challenges are the subset Claude classified as RULEMAKING and that successfully matched a Federal Register rule).
- **Outcome distribution**: 43.9% Upheld, 24.4% Struck Down, 15.4% Mixed, 16.3% Dismissed/Remanded/Other.
...
© 2026 Henry Hirsch. All rights reserved.

This code is published for portfolio review and evaluation. It is not
licensed for use, modification, or redistribution. For any other use,
contact me.
